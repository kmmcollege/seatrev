...
<head>
    <title> responsive Web Template | Home :: w3layouts</title>
...
<body>
    <div id="example1" class="slider-pro">
        ...
        <div class="sp-slides">
            <div class="sp-slide">
                <img class="sp-image" src="images/blank.gif" data-src="images/kmea.jpg" alt=" " data-retina="images/banner1.jpg" />
                ...
                <div class="row justify-content-between align-items-center">
                    ...
                    <div class="col-lg-4 course-right">
                        <form action="#" method="post">
                            <h4 class="text-white text-center mb-3">Search for colleges</h4>
                    ...
                    <div class="login px-4 mx-auto mw-100">
                        ...
                        <form action="login.php" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" name="pswd" class="form-control" id="exampleInputPassword1" placeholder="" required="">
                            </div>
                            <div class="form-check mb-2">
                                <input type="checkbox" class="form-check-input" id="exampleCheck1">
                                <label class="form-check-label" for="exampleCheck1">Check me out</label>
                            </div>
                            <button type="submit" name="btn" class="btn btn-primary submit mb-4">Sign In</button>
                    ...
                    <div class="login px-4 mx-auto mw-100">
                        ...
                        <form action="registration.php" method="post">
                            <div class="form-group">
                                ...
                                <input type="text" name="fullname" class="form-control" id="validationDefault01" placeholder="" required="">
                            </div>
                            <div class="form-group">
                                <label>Address</label>
                                <textarea type="text" name="address" class="form-control" id="validationDefault02" placeholder="" required=""></textarea>
                            </div>
                            <div class="form-group">
                                <label>Contact</label>
                                <input type="number" name="contact" class="form-control" id="validationDefault02" placeholder="" required="">
                            </div>
                             <div class="form-group">
                                <label>Email</label>
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" name="pswd" class="form-control" id="password2" placeholder="" required="">
                            </div>
                                   <label>Gender: </label>
